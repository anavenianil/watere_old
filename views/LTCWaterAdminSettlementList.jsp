...
<!-- Begin : LTCWaterAdminSettlementList.jsp-->
...
<%int i=0; %>
	<display:table name="${sessionScope.ltcWaterSettlementList}" excludedParams="*"
		export="false" class="list" requestURI="" id="settlement" pagesize="20"
		sort="list" cellpadding="2" cellspacing="1">
		<display:column title="Req ID" style="width:3%;vertical-align:middle">&nbsp;<a href="javascript:getltcWaterSettlementDetails('${settlement.requestId}')"><font color="blue">${settlement.requestId}</font></a></display:column>
		<display:column title="Employee ID" style="width:6%;vertical-align:middle">&nbsp;${settlement.sfID}</display:column>
		<display:column title="Issed Advance Amount" style="width:5%;vertical-align:middle">&nbsp;<font size="4.5em"><span class="WebRupee" >R</span></font><input type="text" size="7" readonly="readonly" value="${settlement.totalTicketsAmt}" name="tadaAdvanceAmount" id="tadaAdvanceAmount<%=i %>"/></display:column> <%-- ${advance.advanceAmountAftRes} --%>     <!-- This line has been changed -->
			<display:column title="Settlement Amount" style="width:5%;vertical-align:middle">&nbsp;<font size="4.5em"><span class="WebRupee" >R</span></font><input type="text" size="7" readonly="readonly" value="${settlement.ltcsettleOrReimAmt}" name="tadaAdvanceAmount" id="tadaAdvanceAmount<%=i %>"/></display:column> <%-- ${advance.advanceAmountAftRes} --%>     <!-- This line has been changed -->
...
<!-- End : LTCWaterAdminSettlementList.jsp -->
