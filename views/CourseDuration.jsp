...
<body>
	<form:form method="post" commandName="trainingMaster" id="trainingMaster">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Course Duration</div>
								<%-- Content Page starts --%>
								<div>
									<div class="line">
									...
									<div class="line" style="margin-left: 12%;">
										<div style="margin-left:25%">
											<a href="javascript:courseDurationSubmit('${sessionScope.trainingMstType}',jsonMasterDataList,jsonFinancialYearList,'${trainingMaster.year}');"><div class="appbutton">Submit</div></a>
										</div>
										<a href="javascript:clearCourseDuration();"><div class="appbutton">Clear</div></a>
									...
									<div class="line" id="result">
										<jsp:include page="CourseDurationDataList.jsp"></jsp:include>
									</div>
		...
		<script>
			...
			jsonFinancialYearList=<%=(net.sf.json.JSONArray)session.getAttribute("jsonFinancialYearList") %>;
