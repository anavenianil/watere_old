				...
				<div class="mainDisplay">
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							...
							<div class="headTitle" id="headTitle">Employee Pay Dues Entry</div>
								<%-- Content Page starts --%>
									<div class="line" id="payrunmonth" style="display: none;">
								 	...
								 	<div class="line">
										...
										<div class="quarter"><form:input path="sfidSearchKey" id="sfidSearchKey"  cssClass="formSelect" onblur="javascript:getEmpName(this);"/>
										</div>
										<div class="quarter">
											<div class="expbutton"><a href="javascript:searchPayDues();"><span>Search</span></a></div>
										</div>
									</div>
									<div class="line">
