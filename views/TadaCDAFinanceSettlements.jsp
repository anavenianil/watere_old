...
<!-- begin:TadaCDAFinanceSettlements.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">TADA CDAFinance Settlements</div>
								<%-- Content Page starts --%>
								<div class="line">
									<div id="page-wrap">		
										<div id="tabs">
											<ul>
								        		<li><a href="#fragment-1">CDA Advance</a></li>
								        		<li><a href="#fragment-2">CDA Settlement</a></li>
								        		<li><a href="#fragment-3">CDA Reimbursement</a></li>
								        	</ul>
								        	
								        	 <div id="fragment-1" class="ui-tabs-panel ui-tabs-hide">
												<div class="line" id="cdaAdvanceList">
													<div><jsp:include page="CDATadaTdAdvList.jsp" /></div> 
													</div>
												
												    <div class="expbutton" style="float:right"><a href="javascript:saveCdaAmont('cdaAdvance');"><span>Save</span></a></div>
								         	</div>
								         	<div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
												<div class="line" id="cdasettlementList">
													<div><jsp:include page="CdaTadaTdSettlementList.jsp" /></div>	
												</div>
									  <div class="expbutton" style="float:right"><a href="javascript:getTdFinSettReport('tadaTdSettlement');"><span>Report</span></a></div>
								        
												    <div class="expbutton" style="float:right"><a href="javascript:saveCdaAmont('cdaSettlement');"><span>Save</span></a></div>
								         	     
								         	</div>
								         	
								         	<div id="fragment-3" class="ui-tabs-panel ui-tabs-hide">
												<div class="line" id="cdaReimbursementList">
													<div><jsp:include page="CdaReimbursementList.jsp" /></div>	
												</div>
												    <div class="expbutton" style="float:right"><a href="javascript:saveCdaAmont('cdaReimbursement');"><span>Save</span></a></div>
								         	</div>
...
<!-- End:TadaCDAFinanceSettlements.jsp  -->