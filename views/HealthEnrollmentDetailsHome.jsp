...
<title>Health Enrollment Details</title>
</head>
<body>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Health Enrollment Details</div>
								<!--Page Content Starts  -->
								<div id="tabs">
									<div class="line" id="result"></div>
									<fieldset style="border-color: green">
										<legend>
											<strong><font color='green'><b>Health Enrollment Details</b></font></strong>
										</legend>
										<!-- <div class="line">
										...
										<div id="result" class="line">
											...
											<div id="HealthInsurance">
												...
												<display:table name="${health.healthInsuranceDetails}"
													...
													<display:column title="ID" style="width:8%;text-align: center;">${health.sfid} </display:column>
													</br>
													<display:column title="Name" style="width:15%;text-align: center;">&nbsp;<span
															name="FullName" id="healthName<%=i%>"
															onkeypress="return checkInt(event,'healthName');"
															readonly>${health.fullName}</span>
													</display:column>
													</br>
													<display:column title="Designation" style="width:15%;text-align: center;">&nbsp;<span
													...
													<display:column style="width:20%;text-align: center"
														...
														<span>&nbsp;<span
																...
																readonly><fmt:formatDate value="${health.joiningDate}" pattern="yyyy-MM-dd"/></span>
														</span>
													</display:column>
													</br>
													<display:column title="Status" style="width:6%;text-align: center;">&nbsp;<span
