					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Configure Exam  Exceptional Employees</div>
								<div>
									<%-- Content Page starts --%>	
									<div class="line">
										...
										<div class="quarter">
											<form:select path="sfid" id="sfid" cssClass="formSelect" onchange="javascript:onchangeSfid();">
												...
												<form:options items="${sfidList}" itemValue="key" itemLabel="value"/>													                            																																		
											</form:select>
										</div>
							      ...
							      <div class="line">
									...
									<div class="quarter"><form:input path="mothertongue" id="mothertongue" maxlength="100" readonly="true"></form:input></div>		
	                              </div>
	                             
	                              <div id="qualificationDiv" style="display:none"></div>
	                              
								  <div class="line">
													<div class="quarter leftmar" style="margin-left: 8px;">Remarks<span class='failure'></span></div>
													<div class="quarter"><form:textarea path="remarks" id="remarks" cols="20" rows="3" ></form:textarea></div>
								</div>
								...
								<div class="line" >
												<div class="expbutton" style="margin-left: 25%;"><a onclick="javascript:saveEmployeeDetails();"> <span>Submit</span></a></div>
...
var sfidNameJson = <%= (net.sf.json.JSONArray)session.getAttribute("sfidNameJson") %>
</script>
</html>