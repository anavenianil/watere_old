...
<!-- begin:EmployeeHierarchyReport.jsp -->
...
<title>Employee Logical Hierarchy Report</title>
</head>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Employee Logical Hierarchy Report</div>
								<div>
									<%-- Content Page starts --%>
										<div class="line">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getHierarchyReport();"><div class="appbutton">Submit</div></a></div>	
...
<!-- End:EmployeeHierarchyReport.jsp -->