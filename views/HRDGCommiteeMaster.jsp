							...
							<div class="lightblueBg1">
								...
								<div>
									...
									<div class="line">
										...
										<div   class="quarter bold leftmar">Board Type</div>
										<div class="quarter">
											<form:select path="courseId" id="courseId" cssClass="formSelect" >
												<option value="">Select</option>
												<option value="">MDB</option>
												<option value="">Interview Board</option>
												
											</form:select>
										</div>
										<div class="quarter leftmar">Year<span class="mandatory">*</span></div>
										<div class="quarter">
											<select id="year" name="year" class="formSelect" onchange="getLocalAssessmentList()">
									...
									<div class="line">
										<div   class="quarter bold leftmar">Board Name</div>
										<div class="quarter">
