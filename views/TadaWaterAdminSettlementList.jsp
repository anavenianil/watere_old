...
<%int i=0; %>
	<display:table name="${sessionScope.tadaWaterSettlementList}" excludedParams="*"
		...
		<display:column title="Req ID" style="width:3%;vertical-align:middle">&nbsp;<a href="javascript:gettadaWaterSettlementDetails('${settlement.requestId}')"><font color="blue">${settlement.requestId}</font></a></display:column>
