...
<!-- begin:MTCompletionReportPage.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle" id="title">Completion Details</div>
								<div>
									<%-- Content Page starts --%>
									 <div class="line">
									 
									 <div class="quarter leftmar" style="width:20%;"><b>FromDate & Time</b><span class="mandatory">*</span></div>
										...
										<input name="searchFromDate" id="searchFromDate"  readonly="readonly"  style="height:16px;width:80px;font-size: 11px;font-weight: bold;" value="${mtBean.currentDate}"/>
											         ...
											         <script type="text/javascript">
											          ...
											          <input name="searchFromTime" id="searchFromTime" style="width:45px" readonly="readonly" class="searchFromTime" onmouseover="javascript:timePicker('searchFromTime')" value="00:01"/>
                                        </div>
										<div class="quarter" style="width:15%;"><b>To & Time</b><span class="mandatory">*</span></div>
										<div class="quarter">
										<input name="searchToDate" id="searchToDate"  readonly="readonly"  style="height:16px;width:80px;font-size: 11px;font-weight: bold;" value="${mtBean.currentDate}"/>
											         ...
											         <script type="text/javascript">
											          ...
											          <input name="searchToTime" id="searchToTime" style="width:45px" readonly="readonly" class="searchToTime" onmouseover="javascript:timePicker('searchToTime')" value="23:59"/>
										</div>
									...
									<div class="line">
									 <div class="expbutton" style="margin-left: 30%;"><a onclick="javascript:getCompletionReport();"> <span>Report</span></a></div>
									</div>
...
<!-- End:MTCompletionReportPage.jsp -->