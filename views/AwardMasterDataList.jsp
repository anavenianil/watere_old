...
<div>
	...
	<div id="Pagination">
			<display:table name="${sessionScope.jsonMasterDataList}" excludedParams="*"
				...
				sort="list">
		      		<display:column title="Award Name" style="width:30%">${dataList.name}</display:column>
					<display:column title="Award Money" style="width:30%">${dataList.awardMoney}</display:column>
					
						<display:column style="width:10%;text-align:center" title="Edit">
						<img src="./images/edit.gif"
							id="masterListEdit" onclick="javascript:editAwardMaster(jsonMasterDataList,jsonAwardCategoryList,'${dataList.id}');"/>
					 	</display:column>
						<display:column style="width:10%;text-align:center" title="Delete">
							<img src="./images/delete.gif"
								onclick="javascript:deleteAwardMaster('${dataList.id}');" />
						</display:column>	
