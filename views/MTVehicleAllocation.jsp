					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Allocate Vehicles For Vehicle Requests</div>
								<div>
									<%-- Content Page starts --%>
								 ...
								 <div class="line">
									<div id="page-wrap">		
										<div id="tabs">
											<ul>        		
								        		<li><a href="#fragment-1">Allocate</a></li>
								        		<li><a href="#fragment-2">Edit Allocate</a></li>
								        		
								        	</ul>
									     	<div id="fragment-1" class="ui-tabs-panel">
												<div class="line">
													<div><jsp:include page="MTVehicleAllocationPendingList.jsp" /></div>
												</div>
													
											</div>
								     		<div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
												<div class="line">
												<div><jsp:include page="MTVehicleAllocationCompltedList.jsp" /></div>	
