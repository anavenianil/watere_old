...
<!-- begin:R_EmpGroupwiseReport.jsp -->
...
<title>Group Wise Report</title>
</head>

<body onload="javascript:resetReportList('groupName');">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Group Wise Report</div>
								<div>
									<%-- Content Page starts --%>
										<div class="line">
										<div class="quarter bold leftmar">Group Name<span class="mandatory">*</span></div>
										<div class="quarter">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getGroupWiseReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('groupName');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
