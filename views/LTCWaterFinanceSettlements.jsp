...
<!-- begin:LTCWaterFinanceSettlements.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Annual Leave Finance Settlements</div>
								<%-- Content Page starts --%>
								<div class="line">
									<div id="page-wrap">		
										<div id="tabs">
								         ...
								         <li><a href="#fragment-2" onclick="javascript:clearCheckBox();">Settlement</a></li>    
									     	...
									     	<div id="fragment-1" class="ui-tabs-panel">
												<div class="line" id="advanceList">
													<div><jsp:include page="LTCWaterAdvList.jsp" /></div>	
												</div>
								     		 ...
								     		 <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
												...
												<%-- 	<div><jsp:include page="TadaWaterAdminSettlementList.jsp" /></div> --%>	
													<div><jsp:include page="LTCWaterAdminSettlementList.jsp" /></div>
								         	...
								         	<div id="fragment-3" class="ui-tabs-panel ui-tabs-hide">
												...
												<%-- 	<div><jsp:include page="TadaWaterAdminReimbursementList.jsp" /></div> --%>


													<div><jsp:include page="LTCWaterAdminReimbursementList.jsp" /></div>
...
<!-- End:LTCWaterFinanceSettlements.jsp -->