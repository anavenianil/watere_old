					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Create Travel Type</div>
								<%-- Content Page starts --%>
								<div class="line">
								    <div class="line">
										<div class="quarter leftmar">Mode of Travel<span class="mandatory">*</span></div>
										<div class="quarter">
											<form:input path="travelType" id="travelType" maxlength="30" onkeypress="javascript:return isAlphabetExp(event);"/>
										</div>
									</div>
									<div class="line">
									...
									<div class="line" style="margin-left: 35%;">
											<div class="expbutton"><a onclick="javascript:submitTravelType()"> <span>Submit</span></a></div>
											<div class="expbutton"><a onclick="javascript:clearTravelType()"> <span>Clear</span></a></div>
									</div>	
									<div class="line"><hr /></div>
									<div class="line" id="result">
									  <jsp:include page="TravelTypeList.jsp"></jsp:include>
									</div>																
								</div>					
								<%-- Content Page end --%>
								<div>&nbsp;</div>
