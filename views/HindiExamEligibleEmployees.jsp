...
<title>HindiEmployeeDetailsForExam</title>
</head>
<body>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Eligible Employee Details For Exam</div>
								<div>
									<%-- Content Page starts --%>	
									<div class="line">
								 ...
								 <div class="line">
										<div class="quarter leftmar">Eligible Exams<span class="mandatory">*</span></div>
										<div class="quarter">
							     ...
							     <div class="line">
								  ...
								  <!--  <div class='line'>
									  <div class="quarter leftmar" style="margin-left: 8px;">Employee Eligibility For<span class='failure'>*</span></div>
									  CashAward
									  <input type=checkbox path='' id='check' value='' onchange='javascript:checkQualif()'/>
								      
								       <div class="quarter leftmar" style="margin-left: 8px;"> <span class='failure'></span></div>
								       Increment
								       <input type=checkbox path='' id='check' value='' onchange='javascript:checkQualif()'/>
							       </div>-->
