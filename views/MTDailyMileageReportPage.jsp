					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle" id="title">Daily Mileage Details</div>
								<div>
									<%-- Content Page starts --%>
									<div class="line">
									 ...
									 <div class="line">
										<div class="quarter leftmar" style="width: 50%;"><b>FromDate</b><span class='failure'>*</span>
										
												<input name="searchFromDate" id="searchFromDate"  readonly="readonly"  style="height:16px;width:80px;font-size: 11px;font-weight: bold;" />
										...
										<div class="quarter leftmar" style="width: 45%;"><b>ToDate</b><span class='failure'>*</span>
										
												<input name="searchToDate" id="searchToDate"  readonly="readonly"  style="height:16px;width:80px;font-size: 11px;font-weight: bold;" />
									...
									<div class="line">
									 <div class="expbutton" style="margin-left: 30%;"><a onclick="javascript:getDailyMileageReport();"> <span>Report</span></a></div>
									</div>
...
<!-- End:MTDailyMileageReportPage.jsp -->