...
<!-- LTCWaterAdminReimbursementHome.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">ANNUAL LEAVE ADMIN REIMBURSEMENT </div>
								<div>
									...
									<fieldset style="border-color: green">
										...
										<div>
											...
											<table cellpadding="5">
												...
												<tr>
													<td><b>Remarks : </b></td>
													<td><form:textarea path="reimbursementAdminRemarks"
															id="reimbursementAdminRemarks" rows="2" cols="30" /></td>
												</tr>
												<tr>
													...
													<td><form:input path="reimbursementAdminDate"
														...
														id="date_start_trigger3" /> <script
															...
															Calendar
																	.setup({
																		inputField : "reimbursementAdminDate",
																		ifFormat : "%d-%b-%Y",
																		showsTime : false,
												...
												<tr>
													<td colspan="4">Mode Of Payment  <span class="mandatory">*</span>
														...
														<form:radiobutton path="ltcreimcashorcheck"
															id="ltcreimcashorcheck1" value="CHEQUE"
															onclick="javascript:ltcadvChequeFields('show')" /> <label>Cheque</label>
														<form:radiobutton path="ltcreimcashorcheck"
															onclick="javascript:ltcadvChequeFields('hide')"
															id="ltcreimcashorcheck2" value="CASH" /> <label>Cash</label>
												...
												<tr>
													<td colspan="4">
														<table id="trdata" style="display: none">
																...
																<select name="ltcreimBankName" path="ltcreimBankName" id="ltcreimBankName">
																		<c:forEach var="item"
																...
																<td>Branch Name : <span class="mandatory">*</span>
																	<form:input path="ltcreimBranchName" id="ltcreimBranchName" /></td>
																<td>Cheque No. : <span class="mandatory">*</span> <form:input
																		path="ltcreimChequeNo" id="ltcreimChequeNo" /></td>
															</tr>
															
															
																<tr style="display: none">
																<td>dvno : <span class="mandatory">*</span> <form:input
																		path="ltcreimAdminDvno" id="ltcreimAdminDvno" />DVDate. : <span
																	class="mandatory">*</span>
																</td>

																<td><form:input path="ltcreimAdminDvDate"
																		id="ltcreimAdminDvDate" cssClass="dateClass"
																		readonly="true"
																		onclick="javascript:clearDateText('ltcreimAdminDvDate');" />
																	&nbsp; <img src="./images/calendar.gif"
																	id="date_start_trigger7" /> <script
																		type="text/javascript">
																		Calendar
																				.setup({
																					inputField : "ltcreimAdminDvDate",
																					ifFormat : "%d-%b-%Y",
																					showsTime : false,
											...
											<div class="line" style="margin-left: 35%;">
												<div class="expbutton">
													<a onclick="javascript:ltcAdminWaterReimbursement()"> <span>Submit</span></a>
												</div>
												<div class="expbutton">
													<a onclick="javascript:clearltcAdminWaterReimbursement()"> <span>Clear</span></a>
												</div>
											</div>
...
<!-- End:LTCWaterAdminReimbursementHome.jsp-->
