<!-- Begin :CourseQualificationDataList.jsp-->
		...
		<div id="Pagination">
			<display:table name="${jsonTrainingMstDataList}" excludedParams="*"
				...
				sort="list">
					...
					<display:column title="Discipline" style="width:30%">${dataList.qualification}</display:column>
...
<!-- End : CourseQualificationDataList.jsp -->