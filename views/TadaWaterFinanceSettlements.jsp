...
<!-- begin:TadaWaterFinanceSettlements.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">TA WATER Finance Settlements</div>
								<%-- Content Page starts --%>
								<div class="line">
									<div id="page-wrap">		
										<div id="tabs">
											<ul>        		
									     	...
									     	<div id="fragment-1" class="ui-tabs-panel">
												<div class="line" id="advanceList">
													<div><jsp:include page="TadaWaterAdvList.jsp" /></div>	
												</div>
...
<!-- End:TadaWaterFinanceSettlements.jsp -->