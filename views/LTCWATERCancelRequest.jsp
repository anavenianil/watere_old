...
<title>Annual leave Cancel</title>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Annual Leave Settlement And Cancel</div>
								<div>
 ...
 <tr>
												...
												<td><b>Total Issued Amount: </b>:</td>
													...
													<td><b>Actual Expenditure For All :</b></td>
																<td><form:input path="ltcactualExpenditure" id="ltcactualExpenditure" readonly="true"
															 maxlength="30" size="8"
