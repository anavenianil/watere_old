	...
	<div><%-- Content Page starts --%>
	 <div class="line">
	      <div class="quarter bold">Claim Type<span style="color:red">*</span></div>
				<form:select path="claimType" id="claimType" cssStyle="width:145px;" onchange="javascript:getClaimCdaDetails();">
				<form:option value="select">Select</form:option>
			    <form:options items="${sessionScope.claimTypeMasterList}" itemLabel="claimType" itemValue="id"/>
               </form:select>
	 </div>
	  <div class="line" id="cdaDetails">
	      </div>
