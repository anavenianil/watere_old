...
<body onload="javascript:resetReportList('religionName');">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Religion Wise Report</div>
								<div>
									<%-- Content Page starts --%>
										<div class="line">
										<div class="quarter bold leftmar">Religion<span class="mandatory">*</span></div>
										<div class="quarter">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getReligionWiseReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('religionName');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
