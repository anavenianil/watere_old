...
<body>
				...
				<div class="mainDisplay">
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
						    ...
						    <div class="headTitle">Report Details</div><br></br>	
						    <div class="line">
							...
							<div class="line">								
							   <display:table name="${reportTypesList}" excludedParams="*"
	...
	<script>
	var reportTypesList=<%=(net.sf.json.JSONArray) request.getAttribute("reportTypesList")%>;
