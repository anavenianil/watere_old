...
<!-- begin:LoanPaybillAcquittance.jsp -->
...
<title>Paybill & Acquittance Reports</title>
</head>

<body onload="javascript:clearPaybillDetails();">
	<form:form method="post" commandName="loan" name="LoanpayBill">
		<div>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Paybill & Acquittance Reports</div>
								<%-- Content Page starts --%>
								<div class="line">
									<div id="page-wrap">		
										<div id="tabs">
											<ul>        		
								        		<li><a href="#fragment-1">Conveyance</a></li>
								        		<li><a href="#fragment-2">Festival</a></li>
								        	</ul>
										<div id="fragment-1" class="ui-tabs-panel">
											<div class="line" id="advanceList">
												<div><jsp:include page="ConveyanceAcquittance.jsp" /></div>	
											</div>
										</div>
										<div id="fragment-2" class="ui-tabs-panel">
											<div class="line" id="advanceList">
												<div><jsp:include page="FestivalAcquittance.jsp" /></div>	
											</div>
										</div>
										</div>
									</div>
...
<!-- End:LoanPaybillAcquittance.jsp -->