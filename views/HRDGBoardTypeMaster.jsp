					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle" id="headTitle">HRDG Board Type Master</div>
								...
								<div>
									<div class="line">
										...
										<div class="quarter bold" id="labelType">Board Type<span class="mandatory">*</span></div>
									...
									<div class="line">
										<div style="margin-left:27%;margin-right:5px;float:left;"><a id="createFundType" href="javascript:manageHRDGBoardType('${sessionScope.trainingMstType}');"><div class="appbutton">Submit</div></a></div>
									...
									<div id="result" class="line">
										<jsp:include page="HRDGBoardTypeMasterDataList.jsp" />
									</div>
								</div>
