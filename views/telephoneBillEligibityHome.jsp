...
<!-- begin:telephoneBillEligibityHome.jsp -->
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Telephone Bill Eligibility Details</div>
								<div>
									<%-- Content Page starts --%>
									<div id="result" class="line"></div>
									<div class="line">
										<div class="quarter leftmar">Designation Name<span class="mandatory">*</span></div>
										<div class="quarter"><form:select path="designationId" id="designationId"  cssClass="formSelect" onchange="javascript:selectDesignationWiseEmployees();">
												<form:option value="select">Select</form:option>
												<form:options items="${telephone.designationList}" itemLabel="name" itemValue="id"/>
											</form:select>
												</div>
									</div>
...
<!-- End:telephoneBillEligibityHome.jsp -->