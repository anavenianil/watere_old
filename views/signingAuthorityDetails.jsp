...
<!-- begin:signingAuthorityDetails.jsp -->
...
<title>Signing Authority Master</title>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle"> Signing Authority Master(CGHS,LTC,TADA,MISC CLAIMS)</div>
								<div>
									<%-- Content Page starts --%>
								<div class="line">
								<div class="quarter bold">Authority Type(ACC/CFA)<span style="color:red">*</span></div>
								<form:select path="authorityType" id="authorityType" cssStyle="width:145px;">
						     	<form:option value="select">Select</form:option>
						     	 	<form:option value="ACC">ACC</form:option>
						     	  	<form:option value="CFA">CFA</form:option>
                                </form:select>
								</div>
								<div class="line">
								...
								<div class="line">
										...
										<a href="javascript:submitSigningAuthorityDetails();" class="appbutton">Submit</a>
										<a href="javascript:clearSigningAuthorityDetails();" class="appbutton">Clear</a>
										</div>
									</div>
									<div class="line" id="result"><jsp:include page="signingAuthorityList.jsp"/>
										</div> 
...
<!-- End:signingAuthorityDetails.jsp -->
