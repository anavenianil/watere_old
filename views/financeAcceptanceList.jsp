<!-- Begin : financeAcceptanceList.jsp -->
...
<%int j=1; %>
	<display:table name="${sessionScope.incrementsList}" excludedParams="*"
		...
		<display:column title="Promotion Date" style="width:5%" ><fmt:formatDate pattern="dd-MMM-yyyy" value="${incrementsList.promotionDate}"/></display:column>				
		<display:column title="Effective Date" style="width:5%" ><fmt:formatDate pattern="dd-MMM-yyyy" value="${incrementsList.effectiveDate}"/></display:column>				
	    ...
	    <c:if test="${not empty incrementsList.variableIncr}">
	   		...
	   		<display:column title="Accepted Date" style="width:25%" ><fmt:formatDate pattern="dd-MMM-yyyy" value="${incrementsList.incrementsAccepteddate}"/></display:column>				
	    </c:if>
			<%j++; %>	
			</display:table>			
		</div>
