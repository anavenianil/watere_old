...
<!-- begin:R_CommunityWiseEmpReport.jsp -->
...
<title>Community Wise Report</title>
</head>

<body onload="javascript:resetReportList('community');">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Community Wise Report</div>
								<div>
									<%-- Content Page starts --%>
									<div class="line">
										<div class="quarter bold leftmar">Community Type<span class="mandatory">*</span></div>
										<div class="quarter">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getCommunityWiseReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('community');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
...
<!-- End:R_CommunityWiseEmpReport.jsp -->