...
<title>HRDG Year Book/Calendar</title>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">HRDG Year Book/Calendar</div>
								<%-- Content Page starts --%>
								<div>
									...
									<div class="line">
										...
										<div class="quarter">
											<form:select path="trainingTypeId" id="trainingTypeId" cssClass="formSelect" >
									...
									<div class="line">
										...
										<div class="quarter">
											<form:select path="yearBookType" id="yearBookType" cssClass="formSelect"  onmouseover="setSelectWidth('#yearBookType')">
												<form:option value="">Select</form:option>
												<form:option value="yearBook">Year Book Tabular Form</form:option>
									...
									<div class="line">
										<div style="margin-left:25%">
											...
											<a href="javascript:getHRDGReport();"><div class="appbutton">Report</div></a>
										</div>
