...
<%int i=0; %>
	<display:table name="${sessionScope.ltcWaterReimbursementList}" excludedParams="*"
		export="false" class="list" requestURI="" id="settlement" pagesize="20"
		sort="list" cellpadding="2" cellspacing="1">
		<display:column title="Req ID" style="width:3%;vertical-align:middle">&nbsp;<a href="javascript:getltcWaterReimbursementDetails('${settlement.requestId}')"><font color="blue">${settlement.requestId}</font></a></display:column>
	...
	<script>
	ltcWaterReimbursementList = <%= (net.sf.json.JSONArray)session.getAttribute("ltcWaterReimbursementList") %>;
