...
<!-- begin:R_DesignationWiseReport.jsp -->
...
<body onload="javascript:resetReportList('designation');">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Division Wise Inventory Report</div>
								<div>
									<%-- Content Page starts --%>
										<div class="line">
										<div class="quarter bold leftmar">Division<span class="failure">*</span></div>
										<div class="quarter">
											<form:select path="designation" id="designation" cssClass="formSelect" onmouseover="setSelectWidth('#designation')" >
												...
												<c:forEach var="val" items="${sessionScope.divisionReportHomeList}">
													<form:option value="${val.ID}">${val.NAME}</form:option>
												</c:forEach>
											</form:select>
										</div>
									</div>	
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getDesignationReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('designation');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
...
<!-- End:R_DesignationWiseReport.jsp -->