...
<title>Add Employee for Assessment</title>
</head>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Add Employee for Assessment</div>
								<%-- Content Page starts --%>
								<div class="line">									
									<div class="line">
									...
									<div class="line">
										...
										<div class="quarter">
											<form:input path="expEmp" id="expEmp" onkeypress="javascript:return checkSpecialChar(event);"></form:input>
										</div>
									</div>
									<div class="line">
										<div class="quarter leftmar">Remarks<span class="mandatory">*</span></div>
										<div>										
											<form:textarea path="description" cols="30" rows="4" id="description" onkeypress="textCounter(this,document.forms[0].counter,500);return checkChar(event);" onkeyup="textCounter(this,document.forms[0].counter,500);"/>
											<input type="text" class="counter" name="counter" value="500" id="counter" disabled="disabled"/>										
										</div>
									</div>
									<div class="line" style="margin-left: 25%;">
										<div class="expbutton"><a onclick="javascript:submitExpEmpDetails()"> <span>Submit</span></a></div>
										<div class="expbutton"><a onclick="javascript:resetExpEmpDetails()"> <span>Clear</span></a></div>
									</div>
									<div class="line"><hr /></div>
									<div class="line" id="result">
										<jsp:include page="AddAssessmentList.jsp"></jsp:include>
									</div>
								</div>
								<%-- Content Page end --%>								
								<div>&nbsp;</div>
