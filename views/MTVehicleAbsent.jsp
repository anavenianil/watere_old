...
<title>Vehicle Absent Form</title>
</head>
<body onload="javascript:clearVehicleAbsentDetails();">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1 mtBMW">
								<div class="headTitle">Vehicle Absent Form</div>
								<div>
									<%-- Content Page starts --%>
								  <div class="line">
								...
								<div class="line">
												<div class="expbutton" style="margin-left: 25%;"><a onclick="javascript:saveVehicleAbsentDetails();"> <span>Save</span></a></div>
												<div class="expbutton"><a onclick="javascript:clearVehicleAbsentDetails();"> <span>Clear</span></a></div>
								</div>	
								<div id="result" class="line"><jsp:include page="MTVehicleAbsentList.jsp"></jsp:include></div>
								<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
							</div>
