...
<!-- begin:payEmpConfigurationDetails.jsp -->
				...
				<div class="mainDisplay">
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							...
							<div class="headTitle" id="headTitle">Update Employee Details</div>
								<%-- Content Page starts --%>
								...
								<div class="line">
								   	<div class="line">
										...
										<div class="quarter"><form:input path="sfidSearchKey" id="sfidSearchKey" cssClass="formSelect" onblur="javascript:getEmpName(this);"/></div> <%-- function onkeypress="funPayKeyPress(event,'payEmpDetailsSearch')" is disabled --%>
										<div class="quarter">
											<div class="expbutton"><a href="javascript:payEmpDetailsSearch();"><span>Submit</span></a></div>
										</div>
									</div>
									<div class="line">
...
<!-- End:payEmpConfigurationDetails.jsp -->	