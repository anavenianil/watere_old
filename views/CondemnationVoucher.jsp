...
<!-- begin:CondemnationVoucher.jsp -->
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
<%@ taglib uri="/tags/spring-form" prefix="form"%>
<%@ taglib uri="/tags/spring" prefix="spring"%>
<%@ taglib uri="/tags/fmt" prefix="fmt"%>
<%@ taglib uri="/tags/jstl-c" prefix="c" %>
	<fieldset><legend><strong>Condemnation Voucher</strong></legend>
		...
		<div class="line">
			...
			<div class="quarter">Reason For Condemnation</div>
			<div class="quarter">
				<spring:bind path="mmgVoucher">
					<form:input path="mmgVoucher.rfcondemnation" id="rfcondemnation" maxlength="100"></form:input>
				</spring:bind>
			</div>
		</div>
		<div class="line">
			
			<div class="quarter">INE Number</div>
			<div class="quarter">
				<spring:bind path="mmgVoucher">
					<form:input path="mmgVoucher.ineNum" id="ineNum" maxlength="20"></form:input>
				</spring:bind>
			</div>
		</div>
	</fieldset>
