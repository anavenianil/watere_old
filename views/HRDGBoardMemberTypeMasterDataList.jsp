<!-- Begin :HRDGBoardMemberTypeMasterDataList.jsp -->
		...
		<div id="Pagination">
			<display:table name="${sessionScope.jsonTrainingMstDataList}" excludedParams="*"
				...
				sort="list">
					...
					<display:column title="Members Limit" style="width:30%">${dataList.maxLimit}</display:column>
					
						<display:column style="width:10%;text-align:center" title="Edit">
						<img src="./images/edit.gif"
							id="masterListEdit" onclick="editHRDGBoardMemberType(jsonMasterDataList,${dataList.id});"/>
					 	</display:column>
...
<!-- End : HRDGBoardMemberTypeMasterDataList.jsp -->