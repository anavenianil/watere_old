								...
								<div>
									...
									<div class="line">
										<div style="margin-left:25%">
											<a href="javascript:disciplineSubmit();"><div class="appbutton">Submit</div></a>
										</div>
											<a href="javascript:clearDiscipline();"><div class="appbutton">Clear</div></a>
											<a href="javascript:normalReports('discipline');"><div class="appbutton">Report</div></a>										
									</div>
									<div class="line height"><hr/></div>
									<div class="line" id="displayTable">
										<jsp:include page="DisciplineList.jsp"></jsp:include>
									</div>
