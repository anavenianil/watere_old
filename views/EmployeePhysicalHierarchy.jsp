...
<!-- begin:EmployeePhysicalHierarchy.jsp -->
...
<title>Employee Physical Hierarchy Report</title>
</head>

<body onload="javascript:resetReportList('hierarchy');">
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Employee Physical Hierarchy Report</div>
								<div>
									<%-- Content Page starts --%>
										<div class="line">
										...
										<div class="quarter">
											<form:select path="hierarchy" id="hierarchy" cssClass="formSelect" onmouseover="setSelectWidth('#hierarchy')">
												...
												<form:options items="${sessionScope.HierarchyReports}" itemValue="id" itemLabel="deptName"/>
											</form:select>
										</div>
									</div>	
									<div class="line">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getHierarchyReport('Physical');"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('hierarchy');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
...
<!-- End:EmployeePhysicalHierarchy.jsp -->