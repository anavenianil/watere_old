...
<title>Nominal Role Report</title>
</head>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle" >Nominal Role Report</div>
								<div>
									<%-- Content Page starts --%>
									<div class="line">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getNominalRoleReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetReportList('NominalRoleReport');"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
