...
<div id="slidemenu" class="jqueryslidemenu" >
	<ul>
		...
		<c:if test="${menuLinks.adminKey=='1'}">
			<li>
				<a class="im_jqueryslidemenu" href="#"><img src="./images/ebbtcbindex13_2.png" border = 0px /></a>
			  	<ul>
				  	 <c:if test="${menuLinks.doPartSearch=='1'}">
						<li>
							...
							<ul>
								<li>
									<c:if test="${menuLinks.doPart=='1'}">
										<a href="#">Masters</a>
										<ul>
										<c:if test="${menuLinks.typeMaster=='1'}">
									    <li><a href="javascript:typeHome();">DO Part Type Master</a></li>
									    </c:if>
									    <c:if test="${menuLinks.casualitiesMaster=='1'}">
										<li><a href="javascript:casualitiesHome();">Do Part Casualities Master</a></li>
										</c:if>
										<c:if test="${menuLinks.taskHolder=='1'}">
										<li><a href="javascript:taskHolderHome();">Do Part Task Holder</a></li>
										</c:if>
										<c:if test="${menuLinks.typeDesigMaster=='1'}">
										<li><a href="javascript:typeDesignationMasterHome();">Do Part Type Designation Master</a></li>
										</c:if>
										<c:if test="${menuLinks.assignDesigToTaskHolder=='1'}">
										<li><a href="javascript:doPartDetailsHome();">Assign Designation to TaskHolder</a></li>
										</c:if>
										</ul>
									</c:if>
								</li>
										...
										<li><a href="#">Publish </a>	
											<ul>
													...
													<c:if test="${menuLinks.payFixation=='1'}">
									               		<li><a href="javascript:payFixation();">Pay Fixation</a>
									               			<ul>
													...
													<c:if test="${menuLinks.annualIncrementDopart=='1'}">
															<li><a href="javascript:annualIncrement();">Annual Increment</a>
															<!--	<ul>
															...
															<li><a href="javascript:annualIncrementFinalDetails();">Annual Increment - Update Basic Pay</a>
															</li>
													</c:if>
				  		...
				  		<li>
				    		...
				    		<ul>
								...
								<c:if test="${menuLinks.appointment=='1'}">
									<li><a href="javascript:masterData('appointment')">Appointment Type</a></li>
								</c:if>	
				    			...
				    			<c:if test="${menuLinks.DepartmentTypeMaster=='1'}">
									<li><a href="javascript:masterData('departmentType')">Department Type Master</a></li>
								</c:if>
								...
								<c:if test="${menuLinks.employment=='1'}">
									<li><a href="javascript:masterData('employment')">Employment Type</a></li>
								</c:if>
								<c:if test="${menuLinks.relation=='1'}">
									<li><a href="javascript:masterData('relation')">Family Relations</a></li>
								</c:if>	
								<c:if test="${menuLinks.group=='1'}">
									<li><a href="javascript:masterData('group')">Group</a></li>
								</c:if>																												
								<c:if test="${menuLinks.motherTongue=='1'}">
									<li><a href="javascript:masterData('motherTongue')">Mother Tongue Master</a></li>
								</c:if>
					 			<c:if test="${menuLinks.nominee=='1'}">
									<li><a href="javascript:masterData('nominee')">Nominee Type Master</a></li>
								</c:if>
								<c:if test="${menuLinks.qualification=='1'}">
									<li><a href="javascript:qualificationMaster('qualification')">Qualification</a></li>
								</c:if>	
								<c:if test="${menuLinks.quarterType=='1'}">
									<li><a href="javascript:masterData('quarterType')">Quarter Type</a></li>
								</c:if>																															
								...
								<c:if test="${menuLinks.retirementType=='1'}">
									<li><a href="javascript:masterData('retirementType')">Retirement Type</a></li>
								</c:if>																											
								...
								<c:if test="${menuLinks.subQuarters=='1'}">
									<li><a href="javascript:masterData('subQuarter')">Sub Quarter Type</a></li>
								</c:if>																																														
								<c:if test="${menuLinks.year=='1'}">
									<li><a href="javascript:masterData('year')">Year Master</a></li>
								</c:if>	
								<c:if test="${menuLinks.city=='1'}">
								<li><a href="javascript:masterData('city')">City Master</a></li>
								</c:if>
				    		</ul>
				  		</li>
				  	</c:if>
				  		...
				  		<li>
				    		...
				    		<ul>
								...
								<c:if test="${menuLinks.othersApplyLeave=='1'}">
									<li><a href="javascript:offlineLeave();">Offline Leave Application Entry</a></li>
								</c:if>	
								<c:if test="${menuLinks.createHolidays=='1'}">
									<li><a href="javascript:holidayHome();"><span>Manage Holidays Master</span></a></li>
								</c:if>	
								<c:if test="${menuLinks.leavesMapping=='1'}">
									<li><a href="javascript:leaveRelationMappingHome();"><span>Configure Leave Relation Mappings</span></a></li>
								</c:if>
								<c:if test="${menuLinks.leaveManagement=='1'}">
									<li><a href="javascript:leaveManagementHome();"><span>Configure Leave Types</span></a></li>
								</c:if>				
								<c:if test="${menuLinks.empLeaveAccount=='1'}">
									<li><a href="javascript:empLeaveAccount();"><span>Leave Card/Account</span></a></li>
								</c:if>	
								<c:if test="${menuLinks.leaveTxnSearch=='1'}">
									<li><a href="javascript:leaveTxnSearch();"><span>Leave Txn Search</span></a></li>
								</c:if>	
								<c:if test="${menuLinks.leaveExceptionalEmployee=='1'}">
									<li><a href="javascript:leaveExceptionalEmployee();"><span>Leave Exceptional Employee</span></a></li>
								</c:if>		
								<c:if test="${menuLinks.leaveAdit=='1'}">
									<li><a href="javascript:leaveAdit();"><span>Leave Audit</span></a></li>
								</c:if>	
								<c:if test="${menuLinks.leaveScript=='1'}">
									<li><a href="javascript:leaveScript();"><span>Leave Script</span></a></li>
								</c:if>	
								<c:if test="${menuLinks.availableLeavesReport=='1'}">
									<li><a href="javascript:availableLeavesReport();"><span>Available Leaves Report</span></a></li>
								</c:if>						    			
				    		</ul>
				  		</li>
				  	</c:if>
//					<c:if test="${menuLinks.adminCghs=='1'}"> <!-- Actual: Cghs -->
				  		<li>
				 			<a href="#">CGHS</a>
				    		<ul>
				    			<c:if test="${menuLinks.dislocation=='1'}">
									<li><a href="javascript:masterData('dislocation')">Dispensary Location</a></li>
								</c:if>
								<c:if test="${menuLinks.disnumber=='1'}">
									<li><a href="javascript:masterData('disnumber')">Dispensary Location Mapping</a></li>
								</c:if>
				    			<c:if test="${menuLinks.hospitalDetails=='1'}"><li>
			                        <a href="javascript:referralHospitalHome()">Referral Hospital</a></li>
						        </c:if>
						        <c:if test="${menuLinks.wardType=='1'}"><li>
			                        <a href="javascript:wardTypeHome()">Ward Type Master</a></li>
						        </c:if>
						     
//						        <c:if test="${menuLinks.adminOfflineCghs=='1'}"><li> <!-- Actual: treatment -->
			                        <a href="javascript:treatmentRequestHome('offline')">Offline CGHS Request Form</a></li>
						        </c:if>
						         <c:if test="${menuLinks.cghsFinance=='1'}"><li>
			                        <a href="javascript:cghsFinanceHome()">Medical Settlement</a></li>
						        </c:if>	
						         <c:if test="${menuLinks.awardCategory=='1'}">
									<li><a href="javascript:masterData('awardCategory')">Award Category</a></li>
								</c:if>
				    		</ul>
				  		</li>
	  				</c:if>		 
//				  	<c:if test="${menuLinks.adminLTC=='1'}"> <!-- Actual: ltc -->
				  		<li>
				 			<a href="#">LTC</a>
				    		<ul>
					    		<c:if test="${menuLinks.ltcMaster=='1'}">
					    			<li><a href="javascript:ltcHome('ltcType')">LTC Type</a></li>
									<li><a href="javascript:ltcHome('ltcBlock')">LTC Block</a></li>
									<li><a href="javascript:ltcHome('ltcBlockYear')">LTC Block Year</a></li>
									<li><a href="javascript:ltcHome('ltcPenalInterestMaster')">LTC Penal Interest Master</a></li>
								</c:if>
								<c:if test="${menuLinks.ltcFinanceScreen=='1'}">
									 <li><a href="javascript:FinanceHome();">Tour Settlements</a></li>
								</c:if>
								<c:if test="${menuLinks.ltcExperienceReport=='1'}">
										<li><a href="javascript:ltcExperienceReport();">LTC Employee Experience Status</a></li>
							   </c:if>
					
							</ul>
				  		</li>
				  	</c:if>	
//				  	 <c:if test="${menuLinks.adminMT=='1'}"> <!-- Actual: mt -->
						<li>
							<a href="#">MT</a>
								<ul>
									<c:if test="${menuLinks.mtMasters=='1'}">
										<li>
											<a href='#'>MT Masters</a>
											<ul>
												<li><a href="javascript:mtCategory();">Category Master</a></li>
												<li><a href="javascript:mtModel();">Model Master</a></li>
												<li><a href="javascript:mtTravelAgency();">Travel Agency Master</a></li>
												<li><a href="javascript:mtAddNewVehicle();">Vehicle Master</a></li>
												<li><a href="javascript:mtAddNewDriver();">Driver Master</a></li>
												<li><a href="javascript:mtVehicleVsDriver();">Allocate Driver To Vehicle</a></li>
												<li><a href="javascript:mtAddNewAddress();">Address Details Master </a></li>
												
											</ul>
										</li>
					
										<c:if test="${menuLinks.driverAbsent=='1'}">
													<li><a href="javascript:mtAbsentDriver();">Driver Absent Form</a></li>
												</c:if>
												<c:if test="${menuLinks.vehicleAbsent=='1'}">
													<li><a href="javascript:mtAbsentVehicle();">Vehicle Absent Form</a></li>
												</c:if>
												<c:if test="${menuLinks.vehicleDriverMap=='1'}">
													<li><a href="javascript:mtVehicleVsDriverList();">Change Driver</a></li>
												</c:if>
												...
												<c:if test="${menuLinks.freeDedicatedVehicles=='1'}">
												   <li><a href="javascript:mtGetAllDedicatedVehicles();">Free Dedicated Vehicles</a></li>
												</c:if>
												<c:if test="${menuLinks.mtMileage =='1'}">
													<li><a href="javascript:mtMileage();">Daily Mileage Entry</a></li>
												</c:if>
												<c:if test="${menuLinks.mtOfflineRequest =='1'}">
													<li><a href="javascript:mtOfflineRequest();">Offline Request Form</a></li>
												</c:if>
												<c:if test="${menuLinks.mtReports =='1'}">
													<li><a href="#">Reports</a>
														<ul>
														    <li><a href="javascript:mtDayWiseAllocation();">Daily Allocations</a></li>
														    <li><a href="javascript:mtCompletionDetails();">Completion Details</a></li>
															<li><a href="javascript:getYearlyMileageDetails();">Mileage Card</a></li>
															<li><a href="javascript:mtDailyMileageDetails();">Daily Mileage Entry</a></li>
															<%-- <li><a href="javascript:mtMileageReport('distanceKPLRecord');">Distance Covered And KPL Record</a></li>--%>
														</ul>
													</li>
												</c:if>
									</c:if>
...
//				  	<c:if test="${menuLinks.adminLoan=='1'}"> <!-- Actual: loan -->
			  			<li>
				 			<a href="#">Loan</a>
				    		<ul>	 
					    			<c:if test="${menuLinks.loanMaster=='1'}">
						    			<li>
									 			<a href="#">Loan Master</a>
									 			<ul>
									 				<li><a href="javascript:loanTypeMaster()">Loan Type Master</a></li>
													<li><a href="javascript:loanFestivalMaster()">Loan Festival Master</a></li>
													<c:if test="${menuLinks.loanTypeDetails=='1'}"><li>
					                      			 <a href="javascript:loanTypeDetails()">Loan Type Details</a></li>
							       			        </c:if>
							       			        <c:if test="${menuLinks.loanAmountDetails=='1'}"><li>
					                      			 <a href="javascript:loanAmountDetails()">Loan Amount Details</a></li>
							        			    </c:if>
							        			    <li><a href="javascript:hbaInterestRates()">HBA Interest Rate Master</a></li> 
									 				<li><a href="javascript:gpfRulesMaster()">GPF Rules Master</a></li>
									 				<li><a href="javascript:gpfClosingBalance()">GPF Closing Balance Master</a></li>
									 			</ul>
									 	</li>
					    			</c:if>
					    			<c:if test="${menuLinks.offline=='1'}">
						    			<li>
									 			<a href="#">1)Offline Entry</a>
									 			<ul>
									 			<c:if test="${menuLinks.othersApplyLoan=='1'}">
									 				<li><a href="javascript:offlineLoan();">Offline Loan Application Entry</a></li>
									 			</c:if>
									 			<c:if test="${menuLinks.othersApplyLoanHBA=='1'}">
									 				<li><a href="javascript:offlineLoanHBA()">Offline HBA Application Entry</a></li>
									 			</c:if>
									 			<c:if test="${menuLinks.loanImmediateRelief=='1'}">
									 			   <li><a href="javascript:loanRelief()">Loan Immediate Relief</a></li>
							     			   </c:if>
									 			</ul>
									 	</li>
					    			</c:if>
							       	<c:if test="${menuLinks.hqSendingDetails=='1'}">
								  				<li><a href="javascript:sendingReport()">2) HeadQuarter Sending Details</a></li>
								  	</c:if>	
								  	<c:if test="${menuLinks.hqReports=='1'}">
								    			<li><a href="javascript:conveyanceAdvanceDemand()">3) HeadQuarter Sending Report</a></li>
								    		</c:if>
								  	<c:if test="${menuLinks.hqReceivedDetails=='1'}">
								  				<li><a href="javascript:hqReport()">4) HeadQuarter Received Details</a></li>
								  	</c:if>
								  	<c:if test="${menuLinks.sanctionAndContingent=='1'}">
								    			<li><a href="javascript:sanctionAndContingent()">5) Sanction Report & ContingentBill</a></li>
								    </c:if>
								  	<c:if test="${menuLinks.payAcquittanceReports=='1'}">
								    			<li><a href="javascript:loanPaybillAcquittance()">Paybill & Acquittance Report</a></li>
								    </c:if>
								...
								<a href="#">Promotion</a>
					   			<ul>
					   		       <c:if test="${menuLinks.promotionsMaster=='1'}">
							   			<li>
										 	<a href="#">Promotions Masters</a>
									    	<ul>
						            	        <li><a href="javascript:residencyPeriod();">Residency Period Master</a></li>
						            	        <li><a href="javascript:boardTypeInfo();">Board Master</a></li>
						          	            <li><a href="javascript:localBoard();">Local Assessment Board</a></li>
						          	            <li><a href="javascript:venueDetails();">Venue Details</a></li>	
						          	            <li><a href="javascript:promotionDiscipline();">Discipline Master</a></li>
						          	            <li><a href="javascript:promotionSubDiscipline();">Sub Discipline Master</a></li>
						              		    <li><a href="javascript:addEmpAssessment();">Add Employee for Assessment</a></li>
						              		 </ul>
									  	</li>
								  	</c:if>
				                   <c:if test="${menuLinks.qualifiedCandidates=='1'}">
				                    	<li><a href="javascript:headQuarterSending();">1&2) Eligible Candidates</a></li>	
					              	</c:if>
//					              	<c:if test="${menuLinks.qualifiedCandidatesDOI=='1'}"> <!-- Actual: qualifiedCandidates -->
					              		<li><a href="javascript:qualifiedCandidates();">3) Eligible Candidates With DOI</a></li>	               		
					              	</c:if>	
					              	<c:if test="${menuLinks.promotedCandidates=='1'}">
					               		<li><a href="javascript:promotedCandidates();">4) Promoted Candidates</a></li>	
					              	</c:if>	
					              
					              	<c:if test="${menuLinks.optionalCertificate=='1'}">
					               		<li><a href="javascript:optionalCertificateHome();">5) Option Certificate & Joining Report</a></li>	
					              	</c:if>	
					              	<c:if test="${menuLinks.viewOptionalCertificate=='1'}">
					              	<li><a href="javascript:viewOptionalCertificateHome();">6) View Option Certificates & Update Designation</a></li>
					              	</c:if>
					                <c:if test="${menuLinks.payUpdate=='1'}">
					              	<li><a href="javascript:PromotionPayUpdate();">7) Promotion Pay Update</a></li>
					              	</c:if>
					            </ul>
					 		</li>
 						</c:if>	
							...
							<li><a href="#">Quarter</a>
								<ul>
								    <c:if test="${menuLinks.emuRequestFormDetails=='1'}">
				                       <li><a href="javascript:emuRequestFormDetails();">Emu Request Form</a></li>
			                        </c:if>
									<c:if test="${menuLinks.emuQuarterDetails=='1'}">
										<li><a href="javascript:emuQuarterDetails('alloted');">Quarter Alloted Details </a></li>
									</c:if>
									<c:if test="${menuLinks.emuOccupiedQuarterDetails=='1'}">
										<li><a href="javascript:emuQuarterDetails('occupied');">Quarter Occupied Details</a></li>
									</c:if>
									<c:if test="${menuLinks.emuVacatedQuarterDetails=='1'}">
										<li><a href="javascript:emuQuarterDetails('vacated');">Quarter Vacation Details</a></li>
									</c:if>
									<c:if test="${menuLinks.quarterGradePayMapping=='1'}">
										<li><a href="javascript:quarterGradePay();">Quarter GradePay Mapping</a></li>
									</c:if>		
									
									<c:if test="${menuLinks.quarterOfflineEntry=='1'}">
										<li><a href="javascript:quarterOfflineEntry();">Quarter Offline Entry</a></li>
									</c:if>	
									<c:if test="${menuLinks.emuQuarterVacationDetails=='1'}">
				                       <li><a href="javascript:emuQuarterDetails('vacationCmpl');">Quarter Vacation reports</a></li>
			                        </c:if>	
								</ul>
							</li>
						</c:if>
								    ...
								    <c:if test="${menuLinks.hindiMaster=='1'}">
								      ...
								      <!--<a href='#'>Hindi Masters</a>
								       <ul>-->
								        ...
								        <li><a href="javascript:hindiExamConfig();">Exam Configuration Master</a></li>
								        <li><a href="javascript:hindiEmployee();">Employee Master</a></li>
								        <li><a href="javascript:hindiCashAward();">Cash Award Master</a></li>
								       <li><a href="javascript:hindiExamNomination();">Exam Nomination Master</a></li>
								       <li><a href="javascript:hindiEmpResult();">Employee Result Master</a></li>
...
//					  <c:if test="${menuLinks.adminClaims=='1'}"> <!-- Actual: claims -->
            			<li>
	 						<a href="#">MISC Claims</a>
	 	   					<ul>
	 	   				   <c:if test="${menuLinks.tuiteleCommonMasters=='1'}">
	 	   				   <li>
	 	                   <a href='#'> Common Masters</a>
	 	                   <ul>
	 	                        <li><a href="javascript:tuitionFeeClaimMaster();">Claim Type Master</a></li>
	 	                    </ul>
	 	                   </li>
	 	                 </c:if>  
	 	                 <c:if test="${menuLinks.tuitionFeeMasters=='1'}">
	 	                     <li>
	 	                        <a href='#'> Tuition Fee Masters</a>
	 	                     <ul>
	 	                        <li><a href="javascript:tuitionFeeAcademicYearMaster();"> Standard Master</a></li>
	 	                        <li><a href="javascript:tuitionFeeConfiguration();"> Configuration</a></li>
	 	                        <li><a href="javascript:tuitionFeeLimitMaster();"> Limit Master</a></li>
	 	                       </ul>
	 	                   </li>
	 	                 </c:if>  
	 	                 <c:if test="${menuLinks.telephoneBillMasters=='1'}">
	 	                     <li>
	 	                        <a href='#'> TelephoneBill Masters</a>
	 	                     <ul>     
	 	                        <li><a href="javascript:telePhoneBillDesignationEmployeeDetails();"> Designation Eligibilty Details</a></li>
	 	                        <li><a href="javascript:telePhoneBillDesignationEligibityDetails();"> Employee Eligibilty Details</a></li>
								<li><a href="javascript:telePhoneBillCashAssignmentDetails();"> Cash Assignment Master</a></li>
	 	                    </ul>
	 	                   </li>
	 	                 </c:if>
	 	              	<c:if test="${menuLinks.tuitionFeeFinanceDetails=='1'}">
						        <li><a href="javascript:tutionFeeFinanceDetails();">Claim Finance Details</a></li>
				     	 </c:if>
				      	<c:if test="${menuLinks.tuitionFeeSentToCDA=='1'}">
						        <li><a href="javascript:tuitionFeeSentToCDA();">Claim CDA Details</a></li>
			     	 	</c:if>
						<c:if test="${menuLinks.financeClaimsAmendementDetails=='1'}">
				     	 <li><a href="javascript:financeClaimsAmendementDetails();">TuitionFee\TelephoneBill Employee Claims </a></li>
	      			    </c:if>
					  </ul>
		   			 </li>		
        		     </c:if>
//						<c:if test="${menuLinks.adminPassportRequest=='1'}"> <!-- Actual: passportRequest -->
							  	<li>
							 			<a href="#">PassPort</a>
							    		<ul>
...
//										<c:if test="${menuLinks.adminNocForPassport=='1'}"> <!-- Actual:  nocForPassport-->
	  					...
	  					<c:if test="${menuLinks.trainingMaster=='1'}">
				    		<li>
									 	<a href="#">HRDG</a>
								    	<ul>
								    	    <li><a href="javascript:trainingMaster('trainingType');">Training Type Master</a></li>
								    	    <li><a href="javascript:trainingMaster('trainingInistitute');">Training Institute Master</a></li>
								    	     <li><a href="javascript:trainingMaster('course');">Course Master</a></li>
											 <li><a href="javascript:trainingMaster('HRDGBoardType');">Board Type Master</a></li>
											 <li><a href="javascript:trainingMaster('HRDGBoardMemberType');">Board Member Type Master</a></li>
								    	    <li><a href="javascript:trainingMaster('HRDGBoard');">Board Master</a></li>
								    	    <li><a href="javascript:trainingMaster('TrainingCirculationDetails');">Training Circulation</a></li>
								    	    <li><a href="javascript:trainingMaster('HrdgTrainingNominationDetails');">Nominations and Approvals</a></li>
								    	    <li><a href="javascript:trainingMaster('TrainingNominationsCFASelection');">CFA Approval</a></li>
								    	    <li><a href="javascript:trainingMaster('CourseAttendedDetails');">Attended Course Details</a></li>

											 <li><a href="javascript:trainingMaster('awardMaster');">Award Master</a></li>
											<c:if test="${menuLinks.HRDGReport=='1'}">
											 <li><a href="javascript:trainingMaster('HRDGReport');">Annual HRDG Reports</a></li>
											</c:if>
 		 				 ...
 		 				 <c:if test="${menuLinks.Reports=='1'}">
					  		<li>
					    		...
					    		<ul>
					    			...
					    			<c:if test="${menuLinks.monthlyReport=='1'}">	
					    				<li>
...
//												<c:if test="${menuLinks.annualLastModifiedReport=='1'}"> <!-- Actual: lastModifiedReport -->
...
//												<c:if test="${menuLinks.HierarchyLogicalReport=='1'}"> <!-- Actual: HierarchyReport -->
													<li><a href="javascript:createHierarchyReport()">Employee Logical Hierarchy Report</a></li>
												</c:if>
//												<c:if test="${menuLinks.HierarchyPhysicalReport=='1'}"> <!-- Actual: HierarchyReport -->
...
//												<c:if test="${menuLinks.lastModifiedReport=='1'}">
									...
									<c:if test="${menuLinks.allRequest=='1'}">
...
//						<c:if test="${menuLinks.adminION=='1'}"> <!-- Actual: ION -->
	  					 <li>
	 						<a href="#">ION</a>
	    					<ul>  
	    					<c:if test="${menuLinks.letterNumberFormat=='1'}">
							<li><a href="javascript:letterNumber('letterNumberFormatMaster');"> Create Files</a></li>
							 </c:if>
		...
		<li>
		 <a href="#">CDA</a>
		  <ul>
		   <li>
			<a href="#">TADA</a>
			<ul><c:if test="${menuLinks.cdaMenusub=='1'}">
			<li><a href="javascript:tadaCDAFinanceSettlement();"> Settlements</a></li>
			</c:if>
			</ul>
	   			...
	   			<ul>
	   		       <c:if test="${menuLinks.createEmployee=='1'}">
			   			<li>
					    	...
					    	<ul>
//					    	  <c:if test="${menuLinks.addEmployee=='1'}"> <!-- Actual: createEmployee -->
						           <li><a href="javascript:createEmployee()">Add Employee</a></li>
					          </c:if>
					          <c:if test="${menuLinks.createOuterEmployee=='1'}">
						           <li><a href="javascript:createOtherEmployee()">Add Outside Employee</a></li>
					          </c:if>
					   		 </ul>
					  	</li>
				  	</c:if>
				  	...
				  	<c:if test="${menuLinks.createPaymentDetails=='1'}">
			   			<li>
						 	<a href="#">Add Pay Critical Data</a>
					    	<ul>
//					    	<c:if test="${menuLinks.createBasicPay=='1'}"> <!-- Actual: createPaymentDetails -->
				            ...
				            <c:if test="${menuLinks.payLaonDetails=='1'}">
		               			...
		               			<li><a href="javascript:payHindiIncDetails();">Hindi Incentive</a></li>
               			    </c:if>
				  	...
				  	<c:if test="${menuLinks.dataEntryLeave=='1'}">
			   			<li>
						 	<a href="#">Leave</a>
					    	<ul>
//					    	<c:if test="${menuLinks.leaveBalance=='1'}"><!-- Actual: dataEntryLeave -->
						          <li><a href="javascript:dateEntryHome();"><span>Leave Balance Entry</span></a></li>
					         </c:if>
				             <c:if test="${menuLinks.verifyLeaves=='1'}">
						          <li><a href="javascript:verfyLeaveBalance();"><span>Verify Leave Balance Entry</span></a></li>
					         </c:if>
					    	</ul>
					  	</li>
				  	</c:if>
				 	...
				 	<c:if test="${menuLinks.editEmployee=='1'}">
			   			<li>
						 	<a href="#">Edit PIS Data</a>
					    	 <ul>
//					    	  <c:if test="${menuLinks.editEmployeePIS=='1'}"> <!-- Actual: editEmployee -->
					...
					<c:if test="${menuLinks.pin=='1'}">
									<li><a href="javascript:pinMaster('pin')">Pin Number Master</a></li>
					</c:if>
					   		 </ul>
					  	</li>
				  	</c:if>
					 <li><a href="javascript:EmployeeStatus()">Employee Status</a></li>
				  	<c:if test="${menuLinks.assignRoles=='1'}">
					  		<li>
					 			<a href="#">Assign Roles/Employee Transfer</a>
					    		<ul>
					    			<c:if test="${menuLinks.headMapping=='1'}">
										<li><a href="javascript:orgRoleMapping();">Organisation Role</a></li>
									</c:if>
									<c:if test="${menuLinks.employeeMapping=='1'}">
										<li><a href="javascript:normalEmpMapping();">Default Role</a></li>
									</c:if>			    			
					    		</ul>
					  		</li>
				  	 </c:if>	
				  	 <c:if test="${menuLinks.internalDivision=='1'}">
						<li><a href="javascript:internalEmployeeMap();">Internal Divisions Creation</a></li>
					</c:if>	
				  	<c:if test="${menuLinks.dataValidationReport=='1'}">
						<li><a href="javascript:dataValidationReport();">Data Validation Report</a></li>
					</c:if>	
				 </ul>
				</li>
		</c:if>
		...
		<c:if test="${menuLinks.ViewProfile=='1'}">
	  		<li>
	    		...
	    		<ul>
					...
					<c:if test="${menuLinks.viewEmployee=='1'}">
						<li><a href="javascript:viewGeneral()">View Employee Details</a></li>
					</c:if>
		
					<c:if test="${menuLinks.viewQualification=='1'}">
						<li><a href="javascript:viewQualificationDetails()">View Qualification Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewTraining=='1'}">
						<li><a href="javascript:viewTraining()">View Training Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewPassport=='1'}">
						<li><a href="javascript:viewPassportDetails()">View Passport Details</a></li>
					</c:if>
		
					<c:if test="${menuLinks.viewEmpExperience=='1'}">
						<li><a href="javascript:viewExperienceDetails();">View Experience</a></li>
					</c:if>
		
					<c:if test="${menuLinks.viewPreOrgnDetails=='1'}">
						<li><a href="javascript:viewPreOrganisationDetails();">View Pre-Organisation Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewAwardDetails=='1'}">
						<li><a href="javascript:viewAwardDetails();">View Award Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewHigherQualification=='1'}">
						<li><a href="javascript:higherQualification();">Higher Qualification</a></li>
					</c:if>
					<c:if test="${menuLinks.viewEmuQuarterReports=='1'}">
						<li><a href="javascript:viewEMUQuarterDetails();">EMU Quarter Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewRetirementDetails=='1'}">
						<li><a href="javascript:viewRetirementDetails();">View Retirement Details</a></li>
					</c:if>
	  	...
	  	<li><a class="im_jqueryslidemenu" href="#"><img src="./images/ebbtcbindex3_2.png" border = 0px/></a>
	  		<ul>
			  		...
			  		<li>
			    		...
			    		<ul>	
							...
							<c:if test="${menuLinks.applyLeave=='1'}">
								<li><a href="javascript:leaveApplicationForm();">Leave Application Form</a></li>
							</c:if>
							<c:if test="${menuLinks.cancelLeave=='1'}">
								<li><a href="javascript:leaveSearchHome();">Leave Cancellation/Conversion</a></li>
							</c:if>
							...
							<c:if test="${menuLinks.leaveTxnView=='1'}">
								<li><a href="javascript:leaveTxnView();">Leave Card/Account</a></li>
							</c:if>  			   			
			    		</ul>
			  		</li>
	  	      </c:if>
...
//	  		 <c:if test="${menuLinks.loan=='1'}">
			  		<li>
			 			<a href="#">Loan-Advances</a>
			    		<ul>	 
					        <c:if test="${menuLinks.loanRequest=='1'}">
						  		<li><a href="javascript:loanRequest()">Loan-Advance Request</a></li>
						  	</c:if>
						  	<c:if test="${menuLinks.houseBuilding=='1'}">
						  	    <li><a href="javascript:houseBuildingLoan()">House Building Loan Request</a></li> 
						   </c:if>
...
//	  		<c:if test="${menuLinks.Cghs=='1'}">
		  		<li>
		 			<a href="#">CGHS</a>
		    		<ul>
//				        <c:if test="${menuLinks.treatment=='1'}"><li>
	                        <a href="javascript:treatmentRequestHome('')">CGHS Request Form</a></li>
				        </c:if>
				       
				        <c:if test="${menuLinks.reimbursement=='1'}"><li>
	                        <a href="javascript:reimbursementRequestHome()">CGHS Claims</a></li>
				        </c:if>
//				         <c:if test="${menuLinks.nonReimbursement=='1'}"><li> <!-- Actual: reimbursement -->
	                        <a href="javascript:reimbursementRequest('','noncghsReimbursement')">Non CGHS Claims</a></li>
				        </c:if>	
//				         <c:if test="${menuLinks.emergencyClaims=='1'}"><li> <!-- Actual: reimbursement -->
	                        <a href="javascript:emergencyRequest()">Emergency Claims</a></li>
				        </c:if>
		    		</ul>
		  		</li>
	  	 </c:if>
	  	 <c:if test="${menuLinks.hrdg=='1'}">
			  	<li>
			    		...
			    		<li>
								 	<a href="javascript:trainingMaster('TrainingNominationMaster');">Nomination Form</a>
							    	
						</li>
								
						</c:if>
						<c:if test="${menuLinks.viewTrainingNom=='1'}">
								<li><a href="javascript:trainingMaster('ViewTrainingNominationDetails');">Nomination Details</a></li>
						</c:if>
						
						<c:if test="${menuLinks.HRDGYearBook=='1'}">
								 <li><a href="javascript:trainingMaster('HRDGYearBook');">HRDG Year Book/Calendar</a></li>
						</c:if>
							...
							<a href="#">MT</a>
								<ul>
	  								<c:if test="${menuLinks.vehicleRequestForm=='1'}">
										<li><a href="javascript:mtRequestForVehicle();">Request for Vehicle</a></li>
				...
				<a href="#">TADA</a>
	   			<ul>
				  	...
				  	<c:if test="${menuLinks.tadaTdAdvance=='1'}">
				  	     <li>
				  	        <a href="javascript:tadaTdAdvance();">TADA TD Advance</a>
				  	     </li>
				  	</c:if>
				...
				<a href="#">Quarter</a>
	   			<ul>
	   		        <c:if test="${menuLinks.viewQuarterDetails=='1'}">
				  	     <li>
				  	        <a href="javascript:viewQuarterDetails();">Quarter Request Form</a>
				  	     </li>
				  	</c:if>
				 </ul>
	 		</li>
...
//		<c:if test="${menuLinks.claims=='1'}">
             <li>
	 	     ...
	 	     <ul>
	 	              ...
	 	              <li>
	 	              <a href="javascript:tutionFeeRequestFormHome();">Tuition Fee Request Form</a>
	 	              <%
	                      int check=(Integer)session.getAttribute("telecheck");
	                	  if(check>0){
	  	                  %>
	 	                  <a href="javascript:telePhoneBillRequestHome();">TelePhone Request Form </a>
	 	                  <%
	                       }
	  	                  %>
	 	              <a href="javascript:claimsAmendementDetails();">TuitionFee\TelephoneBill Claims </a>
 		...
 		<c:if test="${menuLinks.changeRequest=='1'}">
	  		<li>
	 			<a href="#">Change Request</a>
	    		<ul>
	    			<c:if test="${menuLinks.pisRequest=='1'}">
						<li><a href="javascript:viewProfile();">Update Contact Number</a></li>
					</c:if>
					<c:if test="${menuLinks.viewAddress=='1'}">
						<li><a href="javascript:viewAddressDetails()">Update Address Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewFamily=='1'}">
						<li><a href="javascript:viewFamily()">Update Family Details</a></li>
					</c:if>
					<c:if test="${menuLinks.viewNominee=='1'}">
						<li><a href="javascript:viewNomineeDetails();">Update Nominee Details</a></li>
					</c:if>	
				</ul>
	  		</li>
	  	</c:if>
	  	<c:if test="${menuLinks.familyPlanningAllowance=='1'}">
						<li><a href="javascript:fpaRequest();">Family Planning Allowance</a></li>
		</c:if>	
//	  	<c:if test="${menuLinks.userSpecificConfigurationWorkflowDelegation=='1'}"> <!-- Actual: userSpecificConfiguration -->
					<li><a href="javascript:roleSpecific()">WorkFlow Delegation</a></li>
		</c:if>	
	  	   ...
	  	   <li>
	    		...
	    		<ul> 
					 <c:if test="${menuLinks.IONMaster=='1'}">
							<li><a href="javascript:letterNumber('letterNumberFormatMaster1');">Create New ION</a></li>
					 </c:if>
//	    			 <c:if test="${menuLinks.editCirculateION=='1'}"> <!-- Actual: IONMaster -->
				          <li><a href="javascript:letterNumber('IONDetails');">Search & Edit ION </a></li>
				          <li><a href="javascript:letterNumber('CirculateION');">Circulate ION</a></li>
					 </c:if>
               ...
               <c:if test="${menuLinks.changepassword =='1'}">	  	
	            ...
	            <li><a href="javascript:EmployeeStatus()">EmployeeStatus</a></li>
	              ...
	              <c:if test="${menuLinks.createLetter=='1'}">
			           <li><a href="javascript:letterNumberReference('letter')">Record Letter Number</a></li>
	               </c:if>
	            ...
	            <c:if test="${menuLinks.MyPromotion=='1'}">
	                     ...
	                     <c:if test="${menuLinks.MyoptionalCertificate=='1'}">
					          <li><a href="javascript:optionalCertificateHome();">Option Certificate & Joining Report</a></li>	
			             </c:if>
			      </ul>
			       	</li>
	               </c:if>
...
//										<c:if test="${menuLinks.nocForPassport=='1'}">
	  	...
	  	<c:if test="${menuLinks.mmg=='1'}">
	  		<li>
	 			<a href="#">Cash Build Up</a>
	    		<ul>
	    			<c:if test="${menuLinks.mmgMaster=='1'}">
				  		<li>
				 			<a href="#">MMGMaster Data</a>
				    		<ul>
				    			<li><a href="javascript:mmgMasterData('inventHolder')">Inventory Holder</a></li>
								<li><a href="javascript:mmgMasterData('accHead')">Account Head</a></li>
								<li><a href="javascript:mmgMasterData('taxType')">Tax Type</a></li>
								<li><a href="javascript:mmgMasterData('uom')">UOM</a></li>
								<li><a href="javascript:mmgMasterData('voucherType')">Voucher Type</a></li>
								<li><a href="javascript:mmgMasterData('itemCompany')">Item Company</a></li>
								<li><a href="javascript:mmgMasterData('itemCategory')">Item Category</a></li>
								<li><a href="javascript:mmgMasterData('itemSubCategory')">Item Sub Category</a></li>
								<li><a href="javascript:mmgMasterData('itemCode')">Item Code</a></li>
								<li><a href="javascript:mmgMasterData('itemSubCode')">Item Sub Code</a></li>
	    			...
	    			<c:if test="${menuLinks.demand=='1'}">
				  		<li>
				 			<a href="#">Demand</a>
				    		<ul>
				    			<li><a href="javascript:raiseDemand();"><span>Raise Demand</span></a></li>
								<li><a href="javascript:securityChecking();"><span>Security Checking</span></a></li>
								<li><a href="javascript:cancelDemand();"><span>Cancel Demand</span></a></li>			
				    		</ul>
				  		</li>
				  	</c:if>	
				  	<c:if test="${menuLinks.invoiceReceipt=='1'}">
				  		<li>
				 			<a href="#">Invoice Receipt</a>
				    		<ul>
				    			<li><a href="javascript:invoiceReceipt();"><span>Invoice Receipt</span></a></li>
								<li><a href="javascript:cancelInvoice();"><span>Cancel Invoice</span></a></li>
				    		</ul>
				  		</li>
				  	</c:if>	
					...
					<c:if test="${menuLinks.reports=='1'}">
				  		<li>
				 			<a href="#">Reports</a>
				    		<ul>
				    			<li><a href="javascript:createLasrModifiedReport('CashPurchaseDemand')">Cash Purchase Demand Report</a></li>
					    		<li><a href="javascript:createLasrModifiedReport('CashPurchaseVoucher')">Cash Purchase Voucher Report</a></li>
					    		<li><a href="javascript:createReservationWiseReport('ledgerReport')">Ledger Report</a></li>
				                <li><a href="javascript:createInventoryReport()">Inventory Report </a></li>
				                <li><a href="javascript:createDivisionWiseReport()">Division Wise Inventory Report </a></li>
				    		</ul>
				  		</li>
				  	</c:if>	
				  	<c:if test="${menuLinks.mmgChangeRequest=='1'}">
				  		<li>
				 			<a href="#">Change Request</a>
				    		<ul>
				    			<li><a href="javascript:viewInventoryHolder()">Update Inventory Holder</a></li>
				    		</ul>
				  		</li>
				  	</c:if>	
				  	<c:if test="${menuLinks.mmgCofiguration=='1'}">
						<li><a href="javascript:mmgConfigurations()">MMG Configurations</a></li>
					</c:if>	    			
	    		</ul>
	  		</li>
	  	</c:if>	
...
<c:if test="${menuLinks.superAdminKey=='1'}">
	<li><a class="im_jqueryslidemenu"  href="#"><img  src="./images/ebbtcbindex12_2.png" border = 0px/></a>
		<ul>
					  		...
					  		<li>
					    		...
					    		<ul>
					    			<c:if test="${menuLinks.deptHierarchyLevel=='1'}">
										<li><a href="javascript:orgLevelStr('departmentLevel')">Create Organisation Levels</a></li>
									</c:if>
									<c:if test="${menuLinks.deptHierarchyInstance=='1'}">
										<li><a href="javascript:departmentsStr()">Create Organisation Structure</a></li>
									</c:if>
									<c:if test="${menuLinks.hierarchyLevelMaster=='1'}">
										<li><a href="javascript:orgLevelStr('roleLevel')">Create Organisation Role Levels</a></li>
									</c:if>
									<c:if test="${menuLinks.hierarchyInstance=='1'}">
										<li><a href="javascript:rolesStr()">Create Organisation Roles</a></li>
									</c:if>				    			
					    		</ul>
					  		</li>
			</c:if>	
			<c:if test="${menuLinks.approles=='1'}">
									<li><a href="javascript:masterData('approles')">Application	Roles</a></li>
			</c:if>
			<c:if test="${menuLinks.applicationRoleMapping=='1'}">
							<li><a href="javascript:appRolesMapping()">Application Roles Mapping</a></li>
		    </c:if>
			<c:if test="${menuLinks.MenuLinksMaster=='1'}">
						 			<li><a href="javascript:menuLinksMapping()">Menu Links Master</a></li>
			</c:if>
			<c:if test="${menuLinks.menuLinksMapping=='1'}">
							<li><a href="javascript:linksMapping()">Menu Links Mapping</a></li>
			</c:if>

							<li><a href="javascript:requestRoleMapping()">Application Roles Request Type Mapping</a></li>
			
			
			
			<c:if test="${menuLinks.configurationDetails=='1'}">
							<li><a href="javascript:configurationDetails()">Configuration Details</a></li>
			</c:if>
	    	...
	    	<!--    <c:if test="${menuLinks.dashBoard=='1'}">
					...
					<c:if test="${menuLinks.createWorkFlow=='1'}">
						<li><a href="javascript:createWorkflow()">Create Work Flow</a></li>
					</c:if>
					<c:if test="${menuLinks.generalWorkflowMap=='1'}">
						<li><a href="javascript:workFlowMapping()">Work Flow Mapping</a></li>
					</c:if>
					<c:if test="${menuLinks.internalWorkflowMap=='1'}">
						<li><a href="javascript:masterData('request')">Internal Workflow Mapping</a></li>
					</c:if>
					...
					<c:if test="${menuLinks.userSpecificConfiguration=='1'}">
						<li><a href="javascript:roleSpecific()">User Specific Configuration</a></li>
					</c:if>	
					<c:if test="${menuLinks.requestDelegation=='1'}">
						<li><a href="javascript:requestDelegation();">Request Delegation</a></li>
					</c:if>								    			
	    		</ul>
	  		</li>
	  	</c:if>	
//		<c:if test="${menuLinks.superAdminION=='1'}"> <!-- Actual: ION -->
	  			<li>
	 			<a href="#">ION</a>
	    		<ul>  
	    		  <c:if test="${menuLinks.letterNumberSeries=='1'}">
	    				<li><a href="javascript:letterNumber('letterNumberMaster');">Letter Number Series</a></li>
	    		  </c:if>
	...
	<c:if test="${menuLinks.gotopayBill=='1'}">
		<li><a href="javascript:goTopayBill();"><span class="gotopay" >Go To PAY</span></a></li>
	</c:if>
	<!--   <li><a href="javascript:changePassword()">Change Password</a></li>
	 <li><a href="javascript:EmployeeStatus()">EmployeeStatus</a></li>
	-->
...
<div class="welcome">
	<div class="logoutIcon"><a href="javascript:logout()"> Logout</a></div>
			...
			<c:when test="${sessionScope.holdRequests.count eq 0}">
				<tr>
					...
					<div style="color: red; font-size: 20px;"
						align="center"><a
						href="javascript:moreRequests('TotalHold')"
						style="color: red; font-size: 20px;"> Total Requests On Hold:
					<u>${fn:length(sessionScope.holdRequests.totalHoldRequests)}</u></a></div>
					</marquee>
				</tr>
			</c:when>
			<c:when
				...
				<tr>
					<marquee direction="right" behavior="alternate">
					<div style="color: red; font-size: 20px;"
						align="center"><a href="javascript:moreRequests('hold')"
						style="color: red; font-size: 20px;"> My Requests On Hold: <u>${sessionScope.holdRequests.count}(Click
					Here& Immediately Take Action)</u></a></div>
					</marquee>
				</tr>
			</c:when>
			<c:otherwise>
				<tr>
					...
					<div style="color: red; font-size: 20px;"
						...
						href="javascript:moreRequests('TotalHold')"
						style="color: red; font-size: 20px;"> Total Requests On Hold:
					<u>${fn:length(sessionScope.holdRequests.totalHoldRequests)}</u></a> - <a
						href="javascript:moreRequests('hold')"
						style="color: red; font-size: 20px;">My Requests On Hold:<u>${sessionScope.holdRequests.count}(Click
					Here & Immediately Take Action)</u></a></div>
					</marquee>
				</tr>
