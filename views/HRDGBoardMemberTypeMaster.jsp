...
<script type="text/javascript">
	...
	clearTrainingMaster('${sessionScope.trainingMstType}');
		});
</script>
<style>
.highlight {
...
<title>HRDG Board Member Type Master</title>
</head>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle" id="headTitle">HRDG Board Member Type Master</div>
								...
								<div>
									<div class="line">
										...
										<div class="quarter bold" id="labelType">Board Member Type<span class="mandatory">*</span></div>
										<div class="quarter"><form:input path="name" id="name" maxlength="50" /></div>
									</div>
									<div class="line">
										
										<div class="quarter bold" style="margin-left:8px;">Members Limit<span class="mandatory">*</span></div>
										<div class="quarter"><form:input path="maxLimit" id="maxLimit" maxlength="50" onkeypress="javascript:return checkInt(event)"/></div>
									</div>
									...
									<div class="line">
										...
										<div class="quarter"><form:textarea path="description" id="description" cols="20" rows="3" onkeypress="textCounter(event,$jq('#description'),$jq('#counter'),500);"
										 ></form:textarea>
											<input type="text" class="counter" name="counter" value="200" id="counter" disabled=""/>
										</div>
									</div>
									...
									<div class="line">
										<div style="margin-left:27%;margin-right:5px;float:left;"><a id="createFundType" href="javascript:manageHRDGBoardMemberType('${sessionScope.trainingMstType}');"><div class="appbutton">Submit</div></a></div>
									...
									<div id="result" class="line">
										<jsp:include page="HRDGBoardMemberTypeMasterDataList.jsp" />
									</div>
								</div>
