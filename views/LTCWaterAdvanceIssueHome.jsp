					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Annual Leave Advance Sanctioned </div>
								<div>
									...
									<fieldset style="border-color: green">
										...
										<div>
											...
											<table cellpadding="5">
												...
												<tr>
													...
													<td><form:input path="amountAdults" id="amountAdults"  onkeypress="javascript:return checkInt(event);"
															onkeyup="javascript:TotalAdultsAount()" /></br>(Amount for each Person)</td>
													<td><form:input path="adultsTotAmt" id="adultsTotAmt" readonly="true"/></br>(Total Amount for Adults)</td>
												</tr>
												<tr>
													...
													<td><form:input path="amountChildren" id="amountChildren"  onkeypress="javascript:return checkInt(event);"
															onkeyup="javascript:TotalChildrenAmt()"/></br>(Amount for each Person)</td>
													<td><form:input path="childrenTotAmt" id="childrenTotAmt" readonly="true"/></br>(Total Amount for Children)</td>
												</tr>
												<tr>
											...
											<div class="line" style="margin-left: 35%;">
												<div class="expbutton">
													<a onclick="javascript:issueLtcAdvance()"> <span>Submit</span></a>
												</div>
												<div class="expbutton">
													<a onclick="javascript:clearissueLtcAdvance()"> <span>Clear</span></a>
												</div>
											</div>
...
<!-- End:LTCWaterAdvanceIssueHome.jsp -->
