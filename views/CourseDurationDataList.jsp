<!-- Begin : CourseDurationDataList.jsp -->
		...
		<div id="Pagination">
			<display:table name="${jsonTrainingMstDataList}" excludedParams="*"
				...
				sort="list">
					...
					<display:column title="Course" style="width:30%">${dataList.course}</display:column>
					<display:column title="Start Date" style="width:30%">${dataList.startDate}</display:column>
					<display:column title="End Date" style="width:30%">${dataList.endDate}</display:column>
					<display:column style="width:10%;text-align:center" title="Edit">
						<img src="./images/edit.gif"
							id="masterListEdit" onclick="editCourseDuration(jsonMasterDataList,${dataList.id})"/>
					 	</display:column>
...
<!-- End : CourseDurationDataList.jsp -->