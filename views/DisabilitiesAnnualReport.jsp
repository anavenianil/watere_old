...
<!-- begin:DisabilitiesAnnualReport.jsp -->
...
<title>Annual Disabilities Report</title>
</head>
					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Annual Disabilities Report</div>
								<div>
									<%-- Content Page starts --%>
									<div class="line">
									...
									<div class="line" style="margin-left: 25%;">
										<div><a href="javascript:getDisabilitiesAnnualReport();"><div class="appbutton">Submit</div></a></div>	
										<div><a href="javascript:resetDisabilities();"><div class="appbutton">Clear</div></a></div>								
									</div>		
									<%-- Content Page end --%>
								</div>
								<div>&nbsp;</div>
...
<!-- End:DisabilitiesAnnualReport.jsp -->