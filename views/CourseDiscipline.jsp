					...
					<div class="whitebox1">
						...
						<div class="whitebox_m1">
							<div class="lightblueBg1">
								<div class="headTitle">Course Discipline</div>
								<%-- Content Page starts --%>
								<div>
									...
									<div class="line">
									<div  class="quarter bold leftmar">Disciplines<span class="failure">*</span></div>
										
									</div>
									<div class="line">
											<div class="leftmar">
												<div style="float: left; width : 35%">
														<form:select path="disciplines" id="SelectLeft2" size="10" multiple="true" cssStyle="width:300px">
															<form:options items="${sessionScope.DisciplineList}" itemValue="id" itemLabel="name"/>
														</form:select>
													</div>
												...
												<div style="float: left; width : 30%">
														<form:select path="discipline" id="SelectRight2" size="10" multiple="true" cssStyle="width:300px">
															<form:options items="${sessionScope.selectedCourseDisciplineList}" itemValue="id" itemLabel="name"/>
														</form:select>
													</div>
											</div>
									</div>
									...
									<div class="line">
										<div style="margin-left:25%">
											<a href="javascript:courseDisciplineSubmit('${sessionScope.trainingMstType}');"><div class="appbutton">Submit</div></a>
										</div>
