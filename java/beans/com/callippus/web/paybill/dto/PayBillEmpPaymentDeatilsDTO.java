...
public class PayBillEmpPaymentDeatilsDTO {
	...
	public int status;
	public String cghsFlag;
	public int payDesignationId;
	public Date vincrStartDate;
	public Date vincrEndDate;
	public int basicId;
	public int gradeId;
	public String washAllwFlag;
	public int basicRefId;
	public int gradeRefId;
	public String payStopRemarks;
	// newly added
	...
	public int getGradeRefId() {
		return gradeRefId;
	}

	public void setGradeRefId(int gradeRefId) {
		this.gradeRefId = gradeRefId;
	}

	public int getBasicRefId() {
		return basicRefId;
	}

	public void setBasicRefId(int basicRefId) {
		this.basicRefId = basicRefId;
	}
	...
	public Date getVincrStartDate() {
		return vincrStartDate;
	}

	public void setVincrStartDate(Date vincrStartDate) {
		this.vincrStartDate = vincrStartDate;
	}

	public Date getVincrEndDate() {
		return vincrEndDate;
	}

	public void setVincrEndDate(Date vincrEndDate) {
		this.vincrEndDate = vincrEndDate;
	}
