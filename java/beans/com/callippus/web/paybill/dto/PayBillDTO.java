...
public class PayBillDTO {
	...
	public int gpfPreInst;
	public int gpfTotAmt;
	...
	public int runSubId;
	public Date runMonthDate;
	public int HdGicCfin;
	public int itRec;
	...
	public Date getRunMonthDate() {
		return runMonthDate;
	}
	public void setRunMonthDate(Date runMonthDate) {
		this.runMonthDate = runMonthDate;
	}
	...
	public int getGpfPreInst() {
		return gpfPreInst;
	}
	public void setGpfPreInst(int gpfPreInst) {
		this.gpfPreInst = gpfPreInst;
	}
	public int getGpfTotAmt() {
		return gpfTotAmt;
	}
	public void setGpfTotAmt(int gpfTotAmt) {
		this.gpfTotAmt = gpfTotAmt;
	}
