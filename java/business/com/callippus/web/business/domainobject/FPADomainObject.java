...
@Service
public class FPADomainObject {
	@Autowired
	private com.callippus.web.controller.common.HibernateUtils hibernateUtils;

	public String updateTxnDetails(FPARequestProcessBean processBean) throws Exception {
		Session session = null;
		FamilyPlanningDTO familyPlanning = null;
		Date payeffecDate=null;
		try {
			session = hibernateUtils.getSession();
			FPARequestProcessBean fpaprocessBean;
			fpaprocessBean = (FPARequestProcessBean) session.get(FPARequestProcessBean.class, processBean.getRequestID());
