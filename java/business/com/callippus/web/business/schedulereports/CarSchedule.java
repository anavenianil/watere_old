...
public class CarSchedule extends JRDefaultScriptlet {
	...
	public void beforePageInit() {
		try {
			...
			if (this.getVariableValue("catTotAmt") != null) {
				s = (BigDecimal) this.getVariableValue("catTotAmt");
				b.setCarTotal(s);
				arr.add(b);
			}
	...
	public void afterColumnInit() {
		try {
			...
			this.setVariableValue("pagewiseCarTotal", x1);
