...
public class PCSchedule extends JRDefaultScriptlet {
	...
	public void beforePageInit() {
		try {
			...
			if (this.getVariableValue("totPCAmt") != null) {
				s = (BigDecimal) this.getVariableValue("totPCAmt");
				b.setPclnTotal(s);
				arr.add(b);
			}
	...
	public void afterColumnInit() {
		try {
			...
			this.setVariableValue("pagewisePCTotal", x1);
