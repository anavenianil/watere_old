...
public class CGEISSchedule extends JRDefaultScriptlet {
	BigDecimal s;
	...
	public void beforePageInit() {
		try {
			...
			if (this.getVariableValue("CGEISTotal") != null) {
				...
				s = (BigDecimal) this.getVariableValue("CGEISTotal");
				b.setCGEISTotal(s);
				arr.add(b);
			}
	...
	public void afterColumnInit() {
		try {
			...
			this.setVariableValue("CGEISPageTotal", x1);
