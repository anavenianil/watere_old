...
public class EOLHPLSchedule extends JRDefaultScriptlet{
	BigDecimal s;
	...
	public void beforePageInit() {
		try {
			...
			if (this.getVariableValue("EOLHPLTotal") != null) {
				...
				s = (BigDecimal) this.getVariableValue("EOLHPLTotal");
				b.setEolhplTotal(s);
				arr.add(b);
			}
	...
	public void afterColumnInit() {
		try {
			...
			this.setVariableValue("EOLHPLPageTotal", x1);
