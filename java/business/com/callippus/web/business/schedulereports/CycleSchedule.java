...
public class CycleSchedule extends JRDefaultScriptlet {
	...
	public void beforePageInit() {
		try {
			...
			if (this.getVariableValue("pagewiseCycleTotal") != null) {
				s = (BigDecimal) this.getVariableValue("pagewiseCycleTotal");
				b.setCycleTotal(s);
				arr.add(b);
			}
	...
	public void afterColumnInit() {
		try {
			...
			this.setVariableValue("pagewiseCycleTotal", x1);
